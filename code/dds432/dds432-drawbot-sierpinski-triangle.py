...
if 0: # Some sizing. Tweak for other sizes.
...
# and then draw them in their colors.
# This also includes the hilight lines as path,
...
saveImage('SierpinskyTriangle%d.svg' % SIZE)
